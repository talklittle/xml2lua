...
public class Drawable2Lua extends DocumentTracer {
	...
	// TODO make an Interface when more Drawable types are handled
	private StateListDrawable2LuaHelper mDrawableHelper;

	@Override
	public void startDocument() throws SAXException {
		printLua("---");
		printLua("-- @usage exported");
		printLua("function createDrawable(Drawables)");
		fIndent++;
	...
	public void startElement(String uri, String localName, String qname, Attributes attributes) throws SAXException {
		// http://grepcode.com/file/repository.grepcode.com/java/ext/com.google.android/android/4.2.2_r1/android/graphics/drawable/Drawable.java#836
		
        if (ELEMENT_SELECTOR.equals(localName)) {
            printLua("local drawable = Drawables:StateListDrawable()");
            printLua("");
            mDrawableHelper = new StateListDrawable2LuaHelper(this);
        }
        else if (mDrawableHelper != null) {
        	mDrawableHelper.startElement(uri, localName, qname, attributes);
        }
        
//        } else if (localName.equals("level-list")) {
//        	printLua("drawable = Drawables:LevelListDrawable()");
//        } else if (localName.equals("layer-list")) {
//        	printLua("drawable = Drawables:LayerDrawable()");
//        } else if (localName.equals("transition")) {
//        	printLua("drawable = Drawables:TransitionDrawable()");
//        } else if (localName.equals("color")) {
//        	printLua("drawable = Drawables:ColorDrawable()");
//        } else if (localName.equals("shape")) {
//        	printLua("drawable = Drawables:GradientDrawable()");
//        } else if (localName.equals("scale")) {
//        	printLua("drawable = Drawables:ScaleDrawable()");
//        } else if (localName.equals("clip")) {
//        	printLua("drawable = Drawables:ClipDrawable()");
//        } else if (localName.equals("rotate")) {
//        	printLua("drawable = Drawables:RotateDrawable()");
//        } else if (localName.equals("animated-rotate")) {
//        	printLua("drawable = Drawables:AnimatedRotateDrawable()");            
//        } else if (localName.equals("animation-list")) {
//        	printLua("drawable = Drawables:AnimationDrawable()");
//        } else if (localName.equals("inset")) {
//        	printLua("drawable = Drawables:InsetDrawable()");
//        } else if (localName.equals("bitmap")) {
//        	printLua("drawable = Drawables:BitmapDrawable(r)");
////            if (r != null) {
////               ((BitmapDrawable) drawable).setTargetDensity(r.getDisplayMetrics());
////            }
//        } else if (localName.equals("nine-patch")) {
//        	printLua("drawable = Drawables:NinePatchDrawable()");
////            if (r != null) {
////                ((NinePatchDrawable) drawable).setTargetDensity(r.getDisplayMetrics());
////             }
//        } else {
////            throw new XmlPullParserException(parser.getPositionDescription() +
////                    ": invalid drawable tag " + localName);
//        }
    }
...
//		}
		...
		if (ELEMENT_SELECTOR.equals(localName)) {
			printLua("");
			printLua("return drawable");

			mDrawableHelper = null;
		}
	}
...
//			}
	...
	public static void main(String[] argv) throws Exception {
        ...
        // variables
        DocumentTracer tracer = new Drawable2Lua();
